 ...
 * </p>
 */
public class ComicJsonDeserializer extends StdDeserializer<Comic> {
     ...
     */
    public ComicJsonDeserializer(Class<?> vc) {
        super(vc);
    }
     ...
     * depending on the fields present in the comic object,
     * and adds each comic object to the Comic object.
     * </p>
     *
     ...
     * @return The deserialized Comic object.
     * @throws IOException If an input or output exception occurred.
     */
    @Override
    public Comic deserialize(
            JsonParser jsonParser,
            DeserializationContext deserializationContext)
            throws IOException {

        ObjectMapper mapper = (ObjectMapper) jsonParser.getCodec();
        JsonNode comicNode = mapper.readTree(jsonParser);
